...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        public void sifirla()
        {
            //Koltuk seçildikten sonra sıralar siliniyor
            sira1 = 0;
            sira2 = 0;
            sira3 = 0;
            sira4 = 0;
        ...
        public void enabled()
        {
            //Koltuk butonları kullanıma kapatılıyor
        ...
        {
            //Seçilen koltuğun verisi alınıyor
            if (sira1 == 1)
            {
            ...
            //Alınan veri veri tabanına ekleniyor
            baglantı.Open();
            OleDbCommand komut = new OleDbCommand("update bilet_tablosu set KOLTUK_NO = '"+label_koltukno.Text.ToString()+"' WHERE ID="+Convert.ToInt32(Form_girisyap.id)+"",baglantı);
        ...
        {
            //Kullanıcı ekranına geri dönüş
            Form_kullanıcı frmkullanıcı = new Form_kullanıcı();
            frmkullanıcı.Show();
            this.Hide();
        ...
        {
            //Koltuk numarası veri tabanından çekiliyor
            int koltuk;
            baglantı.Open();
            OleDbCommand komut = new OleDbCommand("select KOLTUK_NO from bilet_tablosu where NEREYE='"+Form3.nereye+ "' and TARİH='"+Form3.tarih+"'", baglantı);
